...
- Lets you toggle the following caps per role: `gravityforms_view_entries`, `gravityforms_edit_entries`, `gravityforms_delete_entries`, `gravityforms_export_entries`, `gravityforms_create_form`, `gravityforms_edit_forms`, `gravityforms_delete_forms`, `gravityforms_view_settings` (labelled “Access settings” because GF treats it as view/edit).
